...
import { Counter } from "../pages/TaskFour_usestate";
import Task_twenty, {
  Login_twen,
  Products_twen,
  Search_twen,
  Student_twen,
} from "../days/Task_twenty";
import Task_twenty_two from "../days/Task_twenty_two";
import Task_twenty_three from "../days/Task_twenty_three";
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path="/task_twenty" element={<Task_twenty />} />
        <Route path="/task_twenty_two" element={<Task_twenty_two />} />
        <Route
          path="/task_twenty_three"
          element={<Task_twenty_three />}
        />

        <Route path="/toggle" element={<Login_twen />} />
        <Route path="/fetch" element={<Products_twen />} />
        <Route path="/storage" element={<Student_twen />} />
        <Route path="/search" element={<Search_twen />} />
        ...
        <Route path="/Spl_second_week" element={<Spl_second_week />}>
          ...
          <Route
            path="employee"
            element={<Employeecard_spltwo emp={Employeecard} />}
          />
          <Route
            path="product_spltwo"
            element={
          ...
          <Route
            ...
            element={<User_skills_spltwo skill={Skills} />}
          />
          <Route
